...
class TestTomlValidation:
    ...
    def test_validate_valid_toml(self) -> None:
        ...
        toml_text = '[project]\nname = "test"\n'
        errors, _ = validate_output(toml_text, "toml")
        assert errors == []
...
class TestYamlValidation:
    ...
    def test_validate_valid_yaml(self) -> None:
        ...
        errors, _ = validate_output("key: value\n", "yaml")
        assert errors == []
...
"""
    ...
    def test_validate_yaml_parse_is_lenient(self) -> None:
        ...
        errors, _ = validate_output("hello", "yaml")
        assert errors == []
...
class TestPythonValidation:
    ...
    def test_validate_invalid_python_syntax(self) -> None:
        ...
        errors, _ = validate_output("def 123foo():\n    pass\n", "python")
        assert len(errors) > 0
    ...
    def test_validate_empty_str_is_valid_python(self) -> None:
        ...
        errors, _ = validate_output("", "python")
        assert errors == []
...
class TestCustomParseValidators:
    ...
    def test_custom_parse_validator_toml(self) -> None:
        ...
        validators: list[ValidatorSpec] = [ParseValidator(kind="parse", language="toml")]
        errors, _ = validate_output(
            '[project]\nname = "test"\n',
            "toml",
            validators,
    ...
    def test_custom_parse_validator_optional(self) -> None:
        ...
        validators: list[ValidatorSpec] = [
            ParseValidator(kind="parse", language="toml", optional=True)
        ]
        errors, _ = validate_output(
...
class TestCombinedValidators:
    ...
    def test_custom_validator_for_different_language(self) -> None:
        ...
        validators: list[ValidatorSpec] = [ParseValidator(kind="parse", language="json")]
        errors, _ = validate_output(
